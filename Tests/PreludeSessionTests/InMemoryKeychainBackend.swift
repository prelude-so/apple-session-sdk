...
final class InMemoryKeychainBackend: KeychainBackend, @unchecked Sendable {
    ...
    func add(_ attributes: [String: Any]) -> OSStatus {
        ...
        case Self.classGenericPassword:
            ...
            let pk = PasswordKey(service: service, account: account)
            if passwords[pk] != nil {
                return errSecDuplicateItem
            }
            passwords[pk] = Item(value: data as NSData)
    ...
    func update(_ query: [String: Any], attributesToUpdate: [String: Any]) -> OSStatus {
        ...
        let pk = PasswordKey(service: service, account: account)
        guard passwords[pk] != nil else {
            return errSecItemNotFound
        }
        passwords[pk] = Item(value: newData as NSData)
        return errSecSuccess
    }
    ...
    func delete(_ query: [String: Any]) -> OSStatus {
        ...
        case Self.classGenericPassword:
            ...
            let pk = PasswordKey(service: service, account: account)
            return passwords.removeValue(forKey: pk) == nil ? errSecItemNotFound : errSecSuccess

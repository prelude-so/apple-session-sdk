...
final class MigrateTests: XCTestCase {
    ...
    func test_migrate_missingChallengeToken_throwsStructured() async throws {
        ...
        } catch PreludeSessionError.missingChallengeToken {
            // expected
        }
    }
    ...
    func test_migrate_concurrentCallers_shareSingleMigration() async throws {
        ...
        async let a = fixture.client.migrate(MigrateOptions(token: "legacy-bearer"))
        async let b = fixture.client.migrate(MigrateOptions(token: "legacy-bearer"))
